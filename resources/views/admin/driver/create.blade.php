...
@section('title', 'ایجاد راننده جدید');

@section('pageName', 'راننده جدید')
@section('breadcrump')
<div class="col-sm-6">
    <ol class="breadcrumb float-sm-left">
        <li class="breadcrumb-item"><a href="{{ route('admin') }}">خانه</a></li>
        <li class="breadcrumb-item active"> <a href="{{ route('admin.sender.index') }}">رانندگان</a></li>
        <li class="breadcrumb-item active">رانندگان جدید</li>
    </ol>
</div>
<section>
